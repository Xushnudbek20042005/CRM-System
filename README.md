...
1. **Set up the necessary Google API credentials for Google integration:**
    ...
    - Add the authorized redirect URIs in the **Authorized redirect URIs** section. For example:
        ...
        - `http://localhost:8081/employee/settings/handle-granted-access`
        Replace `localhost:8081` with the base URL of your CRM application.
...
1. Access the CRM application in your web browser at `http://localhost:8081`.
